...
add_action( 'tgmpa_register', 'connections_business_directory_offers_register_required_plugins' );

function connections_business_directory_offers_register_required_plugins() {
	...
	$config = array(
		'id'           => 'tsl-local-app',         // Unique ID for hashing notices for multiple instances of TGMPA.
	...
	connections_business_directory_offers_tgmpa( $plugins, $config );
}
...
if ( ! function_exists( 'connections_business_directory_offers_tgmpa' ) ) {
	/**
	 ...
	 */
	function connections_business_directory_offers_tgmpa( $plugins, $config = array() ) {
